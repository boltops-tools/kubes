...
* Automated Suffix Hashes: Automatically appends a suffix hash to ConfigMap and Secret resources. More details in [ConfigMap]({% link _docs/dsl/resources/config-map.md %}) and [Secret]({% link _docs/dsl/resources/secret.md %}) docs.
